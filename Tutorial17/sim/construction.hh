...
class MyDetectorConstruction : public G4VUserDetectorConstruction
{
       ...
       private:
             ...
             G4int nCols, nRows;
             G4Box * solidWorld, * solidRadiator,* solidDetector,*solidAtmosphere;
             //G4Tubs *solidScintillator;
             G4Box *solidScintillator;
             G4LogicalVolume * logicalWorld,* logicalRadiator,* logicalScintillator,*logicalAtmosphere[10];
       ...
       G4bool isCherenkov,isScintillator,isTOF,isAtomsphere;

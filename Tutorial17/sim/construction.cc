...
MyDetectorConstruction::MyDetectorConstruction()
{
   ...
   fMessenger->DeclareProperty("atmosphere",isAtomsphere,"Construct Atomsphere");
...
void MyDetectorConstruction::ConstructAtmosphere()
{
   ...
   for(G4int i=0;i<10;i++)
   {
      logicalAtmosphere[i] = new G4LogicalVolume(solidAtmosphere,Air[i],"logicalAtmosphere");
      physAtmosphere[i] = new G4PVPlacement(0,G4ThreeVector(0,0,zWorld/10.*2*i-zWorld+zWorld/10.),logicalAtmosphere[i],"physAtmosphere",logicalWorld,false,i,true); 
   } 
}
